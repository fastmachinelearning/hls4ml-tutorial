...
function main() {
    ...
    # curl https://www.dropbox.com/s/wvp50u7h2jroict/vivado.tar.gz?dl=1 -o vivado.tar.gz
    cd /tmp/
    curl http://192.168.1.99:8000/vivado.tar.gz -o vivado.tar.gz
    ...
    # curl https://www.dropbox.com/s/meufyrhgcg38i12/pynq-z2.zip?dl=1 -o pynq-z2.zip
    curl http://192.168.1.99:8000/pynq-z2.zip -o pynq-z2.zip
    unzip pynq-z2.zip
    rm pynq-z2.zip
    mv pynq-z2 /opt/Xilinx/Vivado/2019.2/data/boards/board_files/

    # Apply Vivado's y2k22 patch
    # curl https://www.dropbox.com/s/3gv1jq9074d582o/y2k22_patch.zip?dl=1 -o y2k22_patch.zip && \
    curl http://192.168.1.99:8000/y2k22_patch.zip -o y2k22_patch.zip
